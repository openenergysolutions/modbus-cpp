...
Expected<bool> IResponse::parse_function_code(uint8_t function_code, loopser::rseq_t& data)
{
    ...
    loopser::UInt8::read_from(data, read_function_code);
    ...
    if((read_function_code & 0x80) != 0)
    {
        ...
        loopser::UInt8::read_from(data, exception_code);
