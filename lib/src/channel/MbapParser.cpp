...
void MbapParser::parse(loopser::rseq_t data)
{
...
void MbapParser::find_body_size()
{
    ...
    uint16_t length;
    loopser::UInt16::read_from(view, length);
...
void MbapParser::send_data()
{
    ...
    loopser::UInt16::read_from(view, transaction_id);

    uint16_t protocol_id;
    loopser::UInt16::read_from(view, protocol_id);

    uint16_t length;
    loopser::UInt16::read_from(view, length);

    uint8_t unit_id;
    loopser::UInt8::read_from(view, unit_id);
