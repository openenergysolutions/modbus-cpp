...
TEST_CASE("IResponse")
{
    ...
    SECTION("When corresponding function code, then return true")
    {
        ...
        openpal::rseq_t buffer{good_function_code.data(), good_function_code.size()};
    ...
    {
        auto data = openpal::rseq_t::empty();
    ...
    SECTION("When wrong function code, then return malformed exception")
    {
        ...
        openpal::rseq_t buffer{wrong_function_code.data(), wrong_function_code.size()};
    ...
    SECTION("When wrong exception function code, then return malformed exception")
    {
        ...
        openpal::rseq_t buffer{wrong_exception_function_code.data(), wrong_exception_function_code.size()};
    ...
    SECTION("When exception function code with invalid length, then return malformed exception")
    {
        ...
        openpal::rseq_t buffer{exception_function_code_invalid_length.data(), exception_function_code_invalid_length.size()};
    ...
    SECTION("When exception function code without exception code, then return malformed exception")
    {
        ...
        openpal::rseq_t buffer{exception_function_without_code.data(), exception_function_without_code.size()};
    ...
    SECTION("When exception function code, then return modbus exception")
    {
        ...
        openpal::rseq_t buffer{exception_function_code.data(), exception_function_code.size()};
