...
static ReadHoldingRegistersResponse generate_response(size_t num_registers)
{
...
TEST_CASE("ReadHoldingRegistersResponseImpl")
{
    SECTION("Valid request")
    {
        ...
        ReadHoldingRegistersResponse response = generate_response(num_registers);
        ReadHoldingRegistersResponseImpl response_impl{response};
